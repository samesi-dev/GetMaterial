namespace IStock.Reports
{
    partial class Catreport
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Catreport));
            ...
            this.cat = new IStock.cat();
            this.productCategoryBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.product_CategoryTableAdapter = new IStock.catTableAdapters.Product_CategoryTableAdapter();
            ...
            // reportViewer1
            // 
            reportDataSource1.Name = "category";
            reportDataSource1.Value = this.productCategoryBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "IStock.Reports.catreport.rdlc";
            ...
            // cat
            // 
            this.cat.DataSetName = "cat";
            this.cat.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            // 
            // productCategoryBindingSource
            // 
            this.productCategoryBindingSource.DataMember = "Product_Category";
            this.productCategoryBindingSource.DataSource = this.cat;
            // 
            ...
            this.Text = "Catreport";
            this.Load += new System.EventHandler(this.Catreport_Load);
        ...
        private catTableAdapters.Product_CategoryTableAdapter product_CategoryTableAdapter;
    }
}